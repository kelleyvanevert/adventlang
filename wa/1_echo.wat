;; echo.wat
;; Prints back stdin -> stdout, incrementally
;; For some reason the max size read by fd_read is 1024, even though I set the buffer size to be bigger, so I need a loop
(module
    ...
    (func $main (export "_start")
        ...
        (loop $read_loop
          (block $exit_loop
            ...
            ;; iovec[0].buf_len: Set to the actual bytes read ($nread)
