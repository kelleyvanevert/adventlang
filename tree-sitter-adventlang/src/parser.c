...
enum ts_symbol_identifiers {
  ...
  sym_comment_text = 11,
  aux_sym_comment_text_repeat1 = 12,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [34] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line_comment, 2, 0, 0),
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 2, 0, 0),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block_comment, 3, 0, 0),
};
