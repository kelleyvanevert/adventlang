...
pub enum CompileError {
    ...
    #[error("could not type-check document")]
...
impl<'a> JIT<'a> {
    pub fn new(type_checker: &'a TypeCheckerCtx, runtime_overrides: RuntimeOverrides) -> Self {
        ...
        let (module, runtime_fns) = Runtime::new(builder, runtime_overrides);
